...
export async function FeaturedTea() {
  const products = await getCollectionProducts({ collection: "thee" });
    ...
    <section className="mx-auto max-w-7xl px-6 py-10 md:py-14">
      <div className="mb-10">
        <div className="flex items-center justify-between gap-4">
          <h2 className="text-4xl font-light md:text-5xl">Thee</h2>
          <Link
            href="/search/thee"
        ...
        <p className="mt-3 max-w-xl font-sans text-neutral-600 dark:text-neutral-400">
          Losse thee en infusies — zorgvuldig geselecteerd voor elke gelegenheid.
        </p>
      </div>
